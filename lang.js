...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (Lang === "EN") {
      ...
      document.getElementById("Jumbo2").innerHTML = "<strong>Contact Now</strong>"
        ...
        document.getElementById("SH8.1").innerHTML ="As the co-founder and web developer of the Finance for Teachers project, I collaborated with my financial roommate to create a responsive and functional website. Using WordPress and Elementor, I handled the design, navigation, backend development, and conversion optimization and SEO of the site and have been constantly improving it. We are continuously working to enhance and optimize the website to provide the best possible user experience for our visitors."
